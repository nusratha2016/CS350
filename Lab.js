...
console.log(totalCost(cart.filter(isNotPrime).map(applyCoupon).map(applySalesTax).map(applyShippingCost)));

console.log(totalCost(cart.map(applySalesTax).map(applyShippingCost)));
